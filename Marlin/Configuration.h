...
#define STRING_CONFIG_H_AUTHOR "(DREMC, Ender-5-Pro)" // Who made the changes.
...
/**
 * Default Axis Steps Per Unit (steps/mm) #Updated for Anzac Printer
 * Override with M92
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -2, -4 }
...
#define LEVEL_BED_CORNERS
   ...
   */
  #define LEVEL_CORNERS_LEVELING_ORDER { LB, RB, RF, LF }  //was { LF, RF, RB, LB } changed by Anzac
#endif
